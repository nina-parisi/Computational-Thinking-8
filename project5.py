...
#The goal of the game is to keep the blobfish alive and eating the shrimp. Every few loops, the amount of food decreases so it must keep catching shrimp to not die.
...
for i in range(10000000000):
    ...
    if i % 80 == 0:
        ...
        s2 = create_sprite("shrimp.gif", x, 400)
        s2.setheading(270)
